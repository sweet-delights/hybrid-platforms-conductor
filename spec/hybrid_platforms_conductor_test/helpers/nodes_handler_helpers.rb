  ...
  module Helpers
    ...
    module NodesHandlerHelpers
      ...
      def test_nodes_handler
        unless @nodes_handler
          @nodes_handler = HybridPlatformsConductor::NodesHandler.new logger: logger, logger_stderr: logger, cmd_runner: test_cmd_runner
          @nodes_handler.set_loggers_format
        end
        @nodes_handler
      end

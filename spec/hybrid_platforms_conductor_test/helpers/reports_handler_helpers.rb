  ...
  module Helpers
    ...
    module ReportsHandlerHelpers
      ...
      def test_reports_handler
        @reports_handler = HybridPlatformsConductor::ReportsHandler.new logger: logger, logger_stderr: logger, config: test_config, nodes_handler: test_nodes_handler unless @reports_handler
        @reports_handler
      end

  ...
  module Helpers
    ...
    module ActionsExecutorHelpers
      ...
      def test_actions_executor
        @actions_executor = HybridPlatformsConductor::ActionsExecutor.new logger: logger, logger_stderr: logger, cmd_runner: test_cmd_runner, nodes_handler: test_nodes_handler unless @actions_executor
        @actions_executor
      end
